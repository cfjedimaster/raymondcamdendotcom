{
	...
	"url": "/2005/08/06/Ask-a-Jedi-Enhancing-the-Flash-Form-Grid",
	"guid": "677"
}
...
'Male' ) { gender.selectedIndex=0; } else { <br>
...
&nbsp;&nbsp;&nbsp;<FONT COLOR=MAROON>&lt;cfselect name=<FONT COLOR=BLUE>"gender"</FONT> bind=<FONT COLOR=BLUE>"{people.dataProvider[people.selectedIndex]['gender']}"</FONT>&gt;</FONT><br>
